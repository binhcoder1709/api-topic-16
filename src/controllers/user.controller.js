...
const addUserController = async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({message: "add data successfully", user_ID: newUser.key})
    } catch (e) {
...
export {getUsersController, addUserController, changeStatusController, updateDataController, getUserByIdController, deleteUserController}